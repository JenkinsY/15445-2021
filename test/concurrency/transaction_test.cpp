...
// NOLINTNEXTLINE
TEST_F(GradingTransactionTest, SimpleInsertRollbackTest) {
  // txn1: INSERT INTO empty_table2 VALUES (200, 20), (201, 21), (202, 22)
  // txn1: abort
  // txn2: SELECT * FROM empty_table2;
  auto txn1 = GetTxnManager()->Begin();
...
// NOLINTNEXTLINE
TEST_F(GradingTransactionTest, SimpleDeleteRollbackTest) {
...
// NOLINTNEXTLINE
TEST_F(GradingTransactionTest, SimpleUpdateRollbackTest) {
