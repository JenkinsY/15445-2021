...
//     LOG_DEBUG("GetTransactionId seccess");
//   }
//   // test
...
//       LOG_DEBUG("%d txn_id %d rid CheckGrowing seccess", txn_id, (int)rid.GetSlotNum());
//     }
//     for (const RID &rid : rids) {
//       res = lock_mgr.Unlock(txns[txn_id], rid);
//       EXPECT_TRUE(res);
//       CheckShrinking(txns[txn_id]);
//       LOG_DEBUG("CheckShrinking seccess");
//     }
